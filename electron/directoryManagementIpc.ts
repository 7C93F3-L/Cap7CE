...
export interface DirectoryManagementIpcDependencies {
  ...
  discardEmbeddedMetadataCandidates: (directoryPath: string) => Promise<void>;
...
export const registerDirectoryManagementIpc = ({
  ...
  discardEmbeddedMetadataCandidates,
      ...
      },
      {
        ...
        listener: async (_event, directoryId: string) => {
          ...
          try {
            ...
            if (directory) await discardEmbeddedMetadataCandidates(directory.path);
