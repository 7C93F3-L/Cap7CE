...
export const quickCommandSpecs: QuickCommandSpec[] = [
  ...
  { domain: "see", action: "indexed" },
  { domain: "see", action: "unindexed" },
  ...
  { domain: "idx", action: "all" },
  { domain: "idx", action: "dir", requiredArgs: 1, missingArgumentKey: "command.missingDirectoryName" },
  { domain: "idx", action: "continue" },
  { domain: "idx", action: "stop" },
  { domain: "idx", action: "clear", fixedArgs: ["all"] },
