...
type CustomScrollbarOrientation = "vertical" | "horizontal";

const customScrollbarMinThumbSize = 24;
...
const CustomScrollbar = ({ scrollContainerRef, orientation }: {
  ...
  const measure = useCallback(() => {
    ...
    const thumbSize = Math.min(
      trackSize,
      Math.max(customScrollbarMinThumbSize, (clientSize / scrollSize) * trackSize)
    );
