...
const categorySearchKeys: Record<CategoryId, TranslationKey[]> = {
  ...
  appearance: ["stableSettings.category.appearance", "stableSettings.material", "appearance.themeModeLabel", "appearance.themeColor", "appearance.accentColor", "stableSettings.hiddenLabels", "stableSettings.desc.material", "stableSettings.desc.theme", "stableSettings.desc.colors", "stableSettings.desc.hiddenLabels"],
