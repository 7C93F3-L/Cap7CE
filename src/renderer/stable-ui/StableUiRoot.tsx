...
const StableUiRoot = ({ theme, themeStyle, windowMaterial, pinned, pinLabel, search, searchInputRef, inputFeedback, resultStatus, resultContent, overlayContent, sidebar, skim, directoryDropEnabled, onTogglePinned, onSearchChange, onSearchOptionsChange, onSearch, onDirectoryDrop, onDismissOverlay }: StableUiRendererProps) => {
  return (
