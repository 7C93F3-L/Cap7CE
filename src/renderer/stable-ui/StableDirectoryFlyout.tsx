...
const StableDirectoryFlyout = ({ anchor, directory, directories, onMove, onOpen, onEdit, onDelete, onClose }: StableDirectoryFlyoutProps) => {
  ...
  return <StableSidebarFlyout anchor={anchor} label={directory.name} onClose={onClose}>
    ...
    <button type="button" onClick={() => runAndClose(() => onOpen(directory.path))}>{t("context.showInFolder")}</button>
